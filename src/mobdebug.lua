...
local mac = not win and (os and os.getenv and os.getenv('DYLD_LIBRARY_PATH') or not is_file_exists("/proc")) and true or false
local iscasepreserving = win or mac

if mac and not is_file_exists("/library") then -- case sensitive
    iscasepreserving = false
end
